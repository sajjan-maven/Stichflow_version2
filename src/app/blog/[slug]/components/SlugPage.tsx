                ...
                <main className="w-full max-w-[1256px] mx-auto">
                    ...
                    <div className="lg:grid lg:grid-cols-[3fr_1fr] w-full">
                        <article className="px-4 w-full lg:max-w-[718px]">
                            ...
                            {blogPost?.author && (
                                <div className="rounded-3xl bg-[#F8F5F3] shadow-sm p-6 block mt-8">
                                    <div className="flex justify-between items-center">
                                        ...
                                        >
                                            ...
                                            />
                                            <div className="pl-2">
                                                <div className="text-3xl text-gray-700 font-medium">{blogPost.author.name}</div>
                                                <p className="text-lg text-gray-600">{blogPost.author.role}</p>
                                            </div>
                                        </Link>
                                        <SocialMediaComponent blogUrl={blogUrl} title={title} />
                                    </div>
                        ...
                        <div className={styles.rightColumn}>
                            <div className="sticky top-[90px] mt-[12px]">
