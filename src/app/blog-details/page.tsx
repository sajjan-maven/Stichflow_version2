...
const recentPosts = [
  {
    id: 1,
    title:
      "Modern IT is evolving—so why are job boards still stuck in the past? Meet Fwd IT Job Board",
    description:
      ...
      <main className="flex w-full items-start gap-20 pt-20 pb-40 px-6 max-w-[1304px] mx-auto relative">
        ...
        <div className="flex-col w-full lg:w-[829px] items-start gap-16 flex relative">
          ...
          <header className="flex flex-col w-full items-start gap-6 relative bg-transparent">
            <div
              className="inline-flex items-center justify-end gap-2 p-4 rounded-xl border border-solid border-[#54505833]"
            >
              <div className="relative w-4 h-4">
                <Image
                  ...
                  height={16}
                  alt="Icon"
                  src="/blog-details/arrow-left.png"
                />
              </div>
            ...
            <h1 className="self-stretch font-h2-medium text-[#363338]">
              Spring Cleaning for Your SaaS Stack: How to Audit Slack, Zoom, and
              IDP Assignments at Scale
            </h1>
            ...
            <div className="flex items-center gap-6 relative self-stretch w-full">
              ...
              <span className="font-caption-regular text-[#7b7481]">
                Jan 01, 2025
              </span>
            </div>
          </header>
          ...
          <div className="flex flex-col items-start gap-14 relative self-stretch w-full">
            <p className="relative self-stretch font-normal text-[#363338] text-base leading-6">
              As organizations grow, their SaaS environments become increasingly
              complex. Workspaces become cluttered, licenses go underutilized,
              and access assignments become misaligned. <br />
              <br />
              The challenge for IT teams is not a lack of intent to clean up
              these gaps but rather the lack of visibility needed to do so
              effectively.
              <br />
              <br />
              Most SaaS platforms do not provide a customized view of usage,
              forcing IT teams to either manually compile data or invest in
              costly, complex solutions. <br />
              <br />
              Stitchflow addresses this by providing a unified, flexible, and
              data-driven approach to SaaS audits. <br />
              <br />
              Below, we explore three common areas where organizations struggle
              with visibility and how Stitchflow enables a more efficient
              cleanup process.
            </p>
            ...
            <section className="flex flex-col items-start gap-6 relative self-stretch w-full">
              ...
              <p className="self-stretch font-normal text-[#363338] text-base leading-6">
                ...
                <br />
                External channels with vendors or partners that are no longer
                active.
                <br />
                Inactive channels where conversations have stopped for extended
                periods.
                <br />
                <br />
                The problem is that Slack does not offer a single, centralized
                view to audit these channels effectively. <br />
                <br />
                IT teams lack a way to see channel metadata—such as creator,
                type (public, private, shared), external participants, and last
                activity—at scale.
              </p>
              ...
              <p className="self-stretch font-normal text-[#363338] text-base leading-6">
                Provides a comprehensive dashboard displaying all channels with
                key metadata, enabling informed decisions.
                <br />
                Enables IT teams to filter and sort channels based on activity,
                external participation, and creator details.
                <br />
                Streamlines the cleanup process, allowing organizations to bulk
            ...
            <section className="flex flex-col items-start gap-6 relative self-stretch w-full">
              ...
              <p className="self-stretch font-normal text-[#363338] text-base leading-6">
                Zoom licenses represent a significant cost, and they are often
                allocated on an annual basis during contract renewals. To
                optimize spending, IT teams need to determine:
                <br />
                <br />
                How many paid licenses are actively being used.
                <br />
                Which users do not require a full license based on their meeting
                activity.
                <br />
                Whether employees could be downgraded to a basic license (which
                caps meetings at 40 minutes).
              </p>
              ...
              <p className="self-stretch font-normal text-[#363338] text-base leading-6">
                Zoom&#39;s reporting does not accurately indicate whether a user
                is actively participating in meetings, as users can join
                meetings without logging in.
                <br />
                Instead, IT teams need to rely on alternative activity proxies,
                such as whether an employee is regularly hosting meetings and
          ...
          <div className="flex flex-col w-full items-start gap-14 pt-16 pb-0 px-0 relative border-t border-[#eee8e1]">
            <h2 className="flex items-center justify-center gap-2 relative self-stretch w-full">
              <span className="flex-1 font-h1-regular text-[#7b7481]">
                Recent posts
              </span>
            </h2>
              ...
              {recentPosts.map((post) => (
                ...
                >
                  ...
                  <div className="flex flex-col items-start gap-4 relative flex-1 grow">
                    <h3 className="self-stretch font-h4-semibold text-[#363338]">
                      {post.title}
                    </h3>
        ...
        <aside className="hidden lg:flex flex-col w-[347px] items-start gap-6 sticky top-20">
          ...
          <div className="flex flex-col bg-white items-start gap-4 p-8 w-full rounded-[32px] border border-[#545058]">
            <div className="p-0">
              ...
              <p className="self-stretch font-body-regular text-[#363338] mt-4">
                Tanya is an IT product leader. She previously led product at
                atSpoke (acquired by Okta), Okta IGA, Workday, and Lever.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col bg-white items-start gap-4 p-8 w-full rounded-[32px] border border-[#545058]">
            <div className="p-0">
              <h3 className="font-h6-medium text-[#363338] whitespace-nowrap">
                Contents
              </h3>
              ...
              <div className="mt-4 space-y-4">
                {tableOfContents.map((section, index) => (
                  <div key={index} className="space-y-4">
                    <span
                      className={`font-label-medium ${section.isActive ? "text-[#f25c30]" : "text-[#7b7481]"} whitespace-nowrap`}
                    >
                      {section.title}
                    </span>
                    ...
                    {section.subsections.length > 0 && (
                      <div className="flex flex-col items-start gap-4 px-2 py-0">
                        {section.subsections.map((subsection, subIndex) => (
                          <div
                            key={subIndex}
                            className="relative w-[120px] h-4"
                          >
