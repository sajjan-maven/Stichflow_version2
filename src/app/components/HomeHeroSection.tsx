            ...
            <section className="relative w-full py-24 bg-[#f8f5f3] overflow-hidden">
                <div className="flex flex-col w-full max-w-[828px] items-center gap-8 mx-auto">
                    <div className="flex flex-col items-start gap-6 w-full">
                        <h1 className="w-full font-bold text-[#222222] text-[64px] text-center leading-[72px]">
                ...
                <div className="relative w-full">
                    <div className="absolute top-0 flex justify-center gap-4 items-center mb-20 mt-8 w-full">
