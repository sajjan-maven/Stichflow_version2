...
const Button: React.FC<ButtonProps> = ({
    ...
    const variants: Record<string, string> = {
        ...
        secondary:
            "shadow-[0px_2px_12px_#54505840,0px_2px_3px_#54505845,inset_0px_-2px_4px_#00000099] bg-[#363338] bg-gradient-to-b from-[#545058] to-[#363338] hover:to-[#020202] active:to-[#1f1e1f] text-white",
    };
