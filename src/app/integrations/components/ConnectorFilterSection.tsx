            ...
            <div className="w-full max-w-6xl mx-auto">
                <div className="grid gap-4 grid-cols-[0.25fr_1fr] auto-cols-fr content-start items-start">
                    <div id="w-node-_67f7b985-244f-872d-797e-7858cccb8c85-ecc25f2b" className="grid gap-4 grid-cols-1">
                        ...
                        <div className="cta-wrapper secoundary-cta int-page cc-smaller shadow-sm h-full border border-gray-300">
                    ...
                    <div className="cta-wrapper secoundary-cta int-page cc-smaller cc-show-on-mobile shadow-sm h-full border border-gray-300">
                        <div className="content-wrapper">
                            <div className="w-layout-grid hp-wrap gap--625">
                                <Image
                                ...
                                <div className="bg-gray-50 rounded-lg p-6">
                                    <p className="text-gray-700 mb-4">{"Don't see your favorite application?"}</p>

                                    <a
                                        href="mailto:support@stitchflow.io"
                                        className="inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-purple-600 hover:bg-purple-700 transition-colors duration-200 group"
                                    >
