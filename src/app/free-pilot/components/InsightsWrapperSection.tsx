export const InsightsWrapperSection = () => {
  ...
  return (
    <section className="flex flex-col items-center py-20 px-6 w-full gap-20">
      <div className="flex flex-col items-center gap-10 max-w-[1256px] w-full">
        <h2 className="text-[40px] text-center font-semibold text-[#363338] leading-[48px] font-['Geist',Helvetica] w-full">
