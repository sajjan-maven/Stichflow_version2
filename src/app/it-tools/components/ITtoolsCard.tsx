    ...
    <section className="flex flex-col items-center gap-6 py-6 md:py-40 relative w-full z-[2]">
        ...
        {itTools.map((tool, index) => (
            ...
            <div className="p-0 mt-auto">
                <button
                className="inline-flex items-center justify-end gap-2 px-4 py-3 rounded-xl border border-solid border-[#54505833] shadow-[0px_1px_1px_#5450581a,0px_4px_8px_#54505805,inset_0px_-2px_4px_#0000001f] [background:linear-gradient(180deg,rgba(255,255,255,1)_0%,rgba(249,248,250,1)_100%)]"
                >
