                        ...
                        <div className="relative h-[935px] top-35 ">
                            <div className="flex justify-center items-center flex-wrap gap-8">
                                <div className="flex flex-col items-center gap-4 relative self-stretch w-full text-center">
                                    <h1 className="text-center self-stretch font-semibold text-[#363338] text-[40px] leading-[48px]">
                                        Accurate. Continuous. Effortless
                                    </h1>
                                    <p className="text-center self-stretch font-normal text-[#363338] text-lg leading-8">
