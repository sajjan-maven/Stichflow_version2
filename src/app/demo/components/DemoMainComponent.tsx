    ...
    const testimonials = [
        {
            ...
            position: "IT Manager",
            link: "https://www.g2.com/products/stitchflow/reviews/stitchflow-review-11001036"
        },
        {
            ...
            link: "https://www.g2.com/products/stitchflow/reviews/stitchflow-review-10937583"
        },
        {
            ...
            link: "https://www.g2.com/products/stitchflow/reviews/stitchflow-review-11010031"
        ...
        <div className="flex flex-col items-center justify-items-stretch relative bg-[#faf9f8]">
                        ...
                        <div className="flex flex-col items-start relative w-full overflow-hidden">
                            <div className="flex flex-col items-start gap-8 relative w-full mb-10">
                                <div className="flex flex-col items-start relative w-full">
                                    <h1 className="w-full text-center md:text-start font-bold text-[#222222] text-3xl md:text-[40px] md:leading-[54px] mb-8 md:mb-4">
                                        SaaS user management for IT environments that can&apos;t be automated
                                    </h1>
                                    <div className="flex flex-col items-start gap-2 relative w-full">
                                        {benefits.map((benefit, index) => (
                                            <div key={index} className="flex items-start md:items-center justify-center gap-2 w-full">
                                                <Image width={16} height={16} alt="Benefit icon" className="mt-1 md:mt-0" src={benefit.icon} />
                            ...
                            <div className="flex flex-col items-start relative max-w-[578px] w-full overflow-hidden">
                                ...
                                <div className="absolute -right-0.5 bottom-0 h-20 w-[86px] bg-gradient-to-l z-30 from-[#faf9f8] to-[#faf9f800]"></div>
                ...
                <section className="lg:max-w-[50%] w-full bg-[#E9E2D9] px-6">
                    <div className="flex flex-col items-center justify-center gap-4 relative rounded-[32px] w-full h-full py-24 max-w-[455px] mx-auto -mt-10">
                        <div className="flex flex-col items-center gap-6 relative w-full">
                            <h2 className="w-full max-w-[455px] font-medium text-[#222222] text-[35px] leading-[47.2px]">
                        ...
                        {/* Privacy notice */}
                        <p className={`w-full max-w-[392px] text-[#363338] ${step === 1 ? 'block' : 'hidden'} text-xs leading-[16.2px] text-center`}>
            ...
            <section className="flex flex-col items-center justify-center px-6 py-14 md:py-[100px] w-full [background:linear-gradient(0deg,rgba(0,0,0,0.02)_0%,rgba(0,0,0,0.02)_100%),linear-gradient(0deg,rgba(250,249,248,1)_0%,rgba(250,249,248,1)_100%)]">
                ...
                <div className="relative flex flex-col lg:flex-row gap-[18px] w-full max-w-[1064px] mni-h-[490px]">
                    ...
                    <Link href={testimonials[0].link} className="hover:border-blue-400 flex flex-col w-full lg:w-[265px] lg:min-h-[490px] items-start justify-center gap-6 p-8 bg-white rounded-[32px] border border-solid border-[#545058]">
                        <div className="p-0 w-full">
                            <div className="flex flex-col items-start gap-4 w-full">
                    ...
                    <div className="flex flex-col w-full lg:w-[780px] items-start gap-[18px]">
                        {testimonials.slice(1).map((testimonial, index) => (
                            <Link
                                ...
                                key={index}
                                className="hover:border-blue-400 flex flex-col items-start gap-[18px] p-8 w-full bg-white rounded-[32px] border border-solid border-[#545058]"
                            >
                                <div className="p-0 w-full">
                                    <div className="flex flex-col items-start gap-4 w-full">
                                        <p className="font-medium text-[#363338] text-lg leading-[26px]">
