    ...
    <section className="w-full px-6 max-w-[1272px] py-20 md:py-40 mx-auto">
        ...
        <div className="w-full">
            ...
            <div className="flex-1 flex justify-center items-center h-[400px] py-20 bg-[#1a1a1a] rounded-3xl">
                ...
                height={40}
                alt="Turing logo"
                src="/case-study/turing-logo.png"
                />
            </div>
            <div className="flex-1 flex flex-col justify-between p-6">
                ...
                <button
                className="self-start px-4 py-3 mt-2 rounded-xl border border-solid border-[#54505833] shadow-[0px_1px_1px_#5450581a,0px_4px_8px_#54505805,inset_0px_-2px_4px_#0000001f] [background:linear-gradient(180deg,rgba(255,255,255,1)_0%,rgba(249,248,250,1)_100%)]"
                >
                Read story
                </button>
            </div>
