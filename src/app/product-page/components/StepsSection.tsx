      ...
      <div className="w-full max-w-[1256px] mx-auto">
        ...
        >
            ...
            >
                ...
                <div className={`flex-1 flex justify-center items-center grow h-[400px] ${(step.number == 2 || step.number == 3) ? '' : 'bg-white rounded-[32px] overflow-hidden border border-solid border-[#545058]'}`}>
                    {step.image && (
                    <Image
